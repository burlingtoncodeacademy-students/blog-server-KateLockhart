[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=10666954&assignment_repo_type=AssignmentRepo)
# PROJECT: Blog Server
...
- [ ] Endpoint that will display all blog posts/objects from the database. In lieu of database, we use our `blog.json` file.
- [ ] Endpoint that will display one blog post/object from the database selected by its `post_id`
